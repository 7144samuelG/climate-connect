...
interface MessageListProps {
  ...
  data?: (typeof api.messages.getMessages._returnType)["page"];
  canLoadMore: boolean;
      ...
      {Object.entries(groupedMessages || {}).map(([dateKey, messages]) => (
        <div key={dateKey}>
          ...
          {messages.map((message, index) => {
            ...
            const isCompact = prevMessage && prevMessage.member?._id === message.member?._id && differenceInMinutes(
            ...
            return(
                ...
                authorImage={message.member.avatar}
